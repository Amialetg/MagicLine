...
/**
 * Class to to have a tabLayout (circle page indicators) in a recyclerView with SnapHelper
 *
 * Adapted from https://blog.davidmedenjak.com/android/2017/06/24/viewpager-recyclerview.html
 */
class CirclePagerIndicatorDecorationForDetailPage : RecyclerView.ItemDecoration() {
    ...
    override fun onDrawOver(c: Canvas, parent: RecyclerView, state: RecyclerView.State) {
        ...
        val indicatorPosY = parent.height-150.0f
