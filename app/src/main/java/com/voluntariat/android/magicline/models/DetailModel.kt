...
data class DetailModel(val title: String, val subtitle: String, val textBody: String, val link: String, val toolbarImg: Drawable, val isBlack: Boolean = true, val hasToolbarImg: Boolean = false) : Serializable